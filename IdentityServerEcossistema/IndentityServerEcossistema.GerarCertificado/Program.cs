...
namespace IndentityServerEcossistema.GerarCertificado
{
    class Program
    {
        ...
        private static void GerarCertificado()
        {
            ...
            int CinquentaAnos = 50;

            var rsaCert = CreateRsaCertificate("localhost", CinquentaAnos);
            var ecdsaCert = CreateECDsaCertificate("localhost", CinquentaAnos);
